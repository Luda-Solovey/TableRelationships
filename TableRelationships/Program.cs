...
//Домашнє завдання
//Створити приклад на всі звязку - 
//Персона її адреса  1 - 1  Строатегія Каскад
//Команда - Гравець - 1 до багатьох  - стратегія SetNull
//Вчитель - Учень - багато до багатьох 
//Спочатку створити код конвеншеном (підказуємо лиш на 1 до 1) 
//ПРописати флюент апі 
//Проставити дата анотейшн - закоментувати 
//Наповнити все даннними з метода Main
